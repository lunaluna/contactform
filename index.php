		...
		<div class="mainarea">
			...
			<?php endif; ?>
				...
				<?php endif; ?>
					...
					<form method="post" action="contact_judge.php" name="contact_judge" id="contact_judge">
						<div class="form_table">
							<dl>
								<dt><span class="required">お問い合わせ項目</span></dt>
								<dd>

								<?php if ( !isset( $_POST['subject'] ) ) $_POST['subject'] = null; ?>
									<ul>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['selectbox'] ) ) $_POST['selectbox'] = null; ?>
									<p>
										<select name="selectbox" id="selectbox" value="<?php echo ( $_POST['selectbox'] ); ?>">
							...
							<dl>
								...
								<?php if ( !isset( $_POST['company'] ) ) $_POST['company'] = null; ?>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['full_name'] ) ) $_POST['full_name'] = null; ?>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['pref'] ) ) $_POST['pref'] = null; ?>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['address'] ) ) $_POST['address'] = null; ?>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['tel'] ) ) $_POST['tel'] = null; ?>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['fax'] ) ) $_POST['fax'] = null; ?>
							...
							<dl>
								...
								<?php if ( !isset( $_POST['detail'] ) ) $_POST['detail'] = null; ?>
